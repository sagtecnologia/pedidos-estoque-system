...
-- DROP FUNCTION public.dividir_sabor_quantidade();
...
COMMENT ON FUNCTION public.dividir_sabor_quantidade(uuid, numeric, varchar, uuid, text, uuid) IS 'Divide a quantidade de um sabor, criando um novo sabor com parte da quantidade. Mantém o sabor original com a quantidade restante.';
